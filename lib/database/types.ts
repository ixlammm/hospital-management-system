...
export type Patient = Prisma.PatientGetPayload<{ omit: { id: true, ibe_a: true, ibe_r: true, abe_user_key: true } }>;
export type Staff = Prisma.StaffGetPayload<{ omit: { id: true, abe_user_key: true } }>;
...
export type Sample = Prisma.SampleGetPayload<{ omit: { id: true, abe_user_key: true } }>;
...
export type Invoice = Prisma.InvoiceGetPayload<{ omit: { id: true, abe_user_key: true } }>;
